...
copy_txt_btn = Button(root, text="copy text", font=("shanti", 10), height=1, width=15)
...
copy_txt_btn.grid(row=3, column=0)
...
browse_btn = Button(root, textvariable=browse_text, command=lambda:open_file(), font=("Raleway",12), fg="black", height=1, width=15)
browse_text.set("Browse")
